...
public class ObjectTest{
	...
	public static void main(String[] args) {
		...
		Apple a3 = Apple.gerInstance();
		Apple a4 = Apple.gerInstance();
		...
		if(a1 == a2) {
			...
			System.out.println("a1, a21 참조변수 주소값이 다르다.");
		}
		
		if(a3 == a4) {
			System.out.println("a3,a4 참조변수 주소값이 같다");
		}else {
			System.out.println("a3,a4참조변수 주소값이 다르다 ");
		}
