...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		// 문자열 인덱스
		int index1 = message.indexOf("l");      // 문자열 앞에서 부터 소문ㅁ자 l 검색 후 인덱스 반환
		int index2 = message.lastIndexOf("l");  // 문자열 뒤에서 부터 소문ㅁ자 l 검색 후 인덱스 반환
		...
		String result3 = "" + var3; // 위 1,2번 으로 해도 되지만 3번 방법처럼 빈 문자열로 변환하는걸 더 많이 사용함 
